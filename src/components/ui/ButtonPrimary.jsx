...
const ButtonPrimary = ({ children, type = "default", className, onclickfn, isdisabled=false }) => {
  if (type === "border") {
    return (
      <button onClick={()=>{onclickfn()}} className={`bg-linear-to-r p-0.5 rounded-3xl cursor-pointer mx-2 from-indigo-600 to-purple-500 ${className}`} disabled={isdisabled}>
